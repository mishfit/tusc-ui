...
With this worker proposal, we've started a TUSC bug bounty program for security researchers and penetration testers (...aka hackers!) to disclose important security vulnerabilities they find within the TUSC core protocol, reference wallet, and related code repositories.
...
Worker proposal funds will be held in an escrow account by the TUSC Blockchain Foundation and unused funds will be refunded back to the network at the end of the proposal period.
...
* TUSC marketing websites and 3rd party websites/gateways are not eligible for bounties
